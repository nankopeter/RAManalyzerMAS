...
public class Message {
    ...
    public static ACLMessage createProposeMessage(Agent sender, String receiverName, Resource resource, Boolean is_guide, String address) {
        ...
        // is guide communication add address of receiver
        if(is_guide){
        ...
        //log commented by Kris
//        log.info(m);
//        log.info("PROPOSE sent");
    ...
    public static Model resource2Model(Resource resource, Model model) {
        try {
            ...
            while (i.hasNext()) { //this is here to put simple resource values (String, int)  to message as well
            ...
            log.info("Error adding instance to model");
        }
    ...
    public static void register(Agent agent, String agentType) {
        ...
        try {
            ...
            System.err.println(agent.getLocalName() + " registration with DF unsucceeded. Reason: " + e.getMessage()); //$NON-NLS-1$
            agent.doDelete();
        }
    }
