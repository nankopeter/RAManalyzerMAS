...
public class Config {
    ...
    public Config(Map<String, String> properties) {
        ...
        if(IS_SENSOR){
            ...
            REASONING_TIME = Integer.valueOf(properties.get("REASONING_TIME"));
            SENDING_TIME = Integer.valueOf(properties.get("SENDING_TIME")); 
        }
    ...
    public int REASONING_TIME = 5000;
    
    public int SENDING_TIME = 15000;
    
    public int WORK_TIME = 5000;
